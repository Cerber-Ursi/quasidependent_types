...
Разумеется, я не мог остаться в стороне. Результат исследований доступен [на github](https://github.com/Cerber-Ursi/quasidependent_types), а детальный разбор - под катом.
